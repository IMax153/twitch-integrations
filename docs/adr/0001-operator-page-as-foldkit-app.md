...
- Foldkit server rendering. Deferred: it ships from `foldkit/experimental/server`, needs a separate server bundle wired into the Effect Worker, and gains little for a single-operator page. Revisit once it leaves experimental.
